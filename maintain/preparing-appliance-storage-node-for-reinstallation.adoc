...
IMPORTANT: Não tente acelerar a reinicialização desligando a alimentação ou reiniciando o aparelho. Você pode interromper atualizações automáticas de BIOS, BMC ou outras atualizações de firmware.
