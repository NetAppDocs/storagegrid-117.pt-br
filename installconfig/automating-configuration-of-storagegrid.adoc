...
NOTE: Também pode configurar o sistema utilizando a link:../primer/exploring-grid-manager.html["Gerenciador de grade"] ou a link:overview-of-installation-rest-apis.html["API de instalação"].
