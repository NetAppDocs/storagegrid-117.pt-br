...
. link:../commonhardware/changing-mtu-setting.html["Modifique as configurações MTU"] Conforme necessário para garantir que eles sejam iguais para a interface de rede de Grade (eth0) em todos os nós.
+
...
NOTE: Consulte também link:../commonhardware/changing-mtu-setting.html["Altere a definição MTU"].
...
Para obter mais informações sobre como ativar a clonagem MAC, consulte as instruções para link:../rhel/configuring-host-network.html["Red Hat Enterprise Linux ou CentOS"] ou link:../ubuntu/configuring-host-network.html["Ubuntu ou Debian"].
...
Para obter mais informações sobre como usar o modo promíscuo, consulte as instruções para link:../rhel/configuring-host-network.html["Red Hat Enterprise Linux ou CentOS"] ou link:../ubuntu/configuring-host-network.html["Ubuntu ou Debian"].
