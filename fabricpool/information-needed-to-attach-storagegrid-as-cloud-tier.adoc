...
.. Crie uma regra ILM para dados do FabricPool e adicione-a à sua política ILM ativa. link:using-storagegrid-ilm-with-fabricpool-data.html["Configure o ILM para dados do FabricPool"]Consulte .
