...
.Sobre esta tarefa
Especificar link:../commonhardware/checking-dns-server-configuration.html["Informações do servidor DNS"] permite que você use nomes de host de nome de domínio totalmente qualificados (FQDN) em vez de endereços IP para notificações de e-mail e AutoSupport.
