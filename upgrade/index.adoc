...
Estas instruções descrevem as novidades do StorageGRID 11,7 e fornecem instruções passo a passo para atualizar todos os nós do seu sistema StorageGRID para a nova versão.



== Antes de começar

Revise esses tópicos para saber mais sobre os novos recursos e aprimoramentos no StorageGRID 11,7, determinar se algum recurso foi descontinuado ou removido e descobrir as alterações nas APIs do StorageGRID.

* link:whats-new.html["Novidades do StorageGRID 11,7"]
