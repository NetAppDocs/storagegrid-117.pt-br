...
Há muitas maneiras de obter nomes consistentes de interface de rede entre vários hosts; link:configuring-host-network.html["Configurando a rede host"]consulte para obter alguns exemplos.
