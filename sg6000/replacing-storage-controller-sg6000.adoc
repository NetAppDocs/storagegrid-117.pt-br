...
== Ste 2: Coloque o controlador offline
...
IMPORTANT: *Possível perda de acesso aos dados e n.o 8212;* se os dois números de peça não forem os mesmos, não tente este procedimento.
