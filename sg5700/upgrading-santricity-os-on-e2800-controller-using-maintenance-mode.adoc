...
* Você deve colocar o controlador E5700SG no link:../maintain/placing-appliance-into-maintenance-mode.html["modo de manutenção"], o que interrompe a conexão com o controlador E2800.
+
...
.Passos
. Confirme se o aparelho está link:../maintain/placing-appliance-into-maintenance-mode.html["modo de manutenção"]em .
