...
--
StorageGRID_storage_utilization_data_bytes:: Uma estimativa do tamanho total dos dados de objetos codificados de apagamento e replicados no nó de storage.
