...
. Retorne à página *SSM* > *Resources* e verifique se o status de Multipath ""degradado"" mudou para ""nominal"" na seção hardware de armazenamento.
...
Se este alarme atingir o limite de 90%, é apresentado um aviso no painel de instrumentos do Gestor de grelhas. Você deve executar um procedimento de expansão para adicionar novos nós de storage o mais rápido possível. link:../expand/index.html["Expanda sua grade"]Consulte .
