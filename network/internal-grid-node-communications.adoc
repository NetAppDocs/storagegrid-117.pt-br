...
Todos os nós
 a| 
Fornece o serviço DNS multicast (mDNS) usado para alterações de IP em toda a grade e para a descoberta do nó administrativo primário durante a instalação, expansão e recuperação.
